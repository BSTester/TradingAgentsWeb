...
DEFAULT_CONFIG = {
    ...
    "backend_url": _env("TRADINGAGENTS_OPENAI_BASE_URL", "OPENAI_BASE_URL", "https://api.openai.com/v1"),
    "embedding_backend_url": _env("TRADINGAGENTS_EMBEDDING_BASE_URL", "EMBEDDING_BASE_URL", _env("TRADINGAGENTS_OPENAI_BASE_URL", "OPENAI_BASE_URL", "https://api.openai.com/v1")),
