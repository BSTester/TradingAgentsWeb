      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link href="/" className="block">
          <div className="flex justify-center cursor-pointer group">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-3 rounded-full shadow-lg group-hover:shadow-xl transition-shadow">
              <i className="fas fa-robot text-white text-3xl" />
            </div>
          </div>
          <h1 className="mt-4 text-center text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent cursor-pointer hover:opacity-80 transition-opacity">
            TradingAgents
          </h1>
          <p className="mt-1 text-center text-sm text-gray-500 cursor-pointer hover:text-gray-700 transition-colors">
            多智能体大语言模型金融交易框架
          </p>
        </Link>
